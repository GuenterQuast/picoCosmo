...
class Ui_CosmoWindow(object):
    def setupUi(self, CosmoWindow):
        ...
        self.label.setGeometry(QtCore.QRect(210, 560, 60, 30))
        font = QtGui.QFont()
        font.setFamily("Latin Modern Sans")
        font.setPointSize(11)
        ...
        self.lE_RunTag.setGeometry(QtCore.QRect(282, 560, 131, 31))
        self.lE_RunTag.setObjectName("lE_RunTag")
        self.pB_StartRun = QtWidgets.QPushButton(self.Tab_Control)
        self.pB_StartRun.setGeometry(QtCore.QRect(500, 590, 101, 40))
        icon = QtGui.QIcon()
