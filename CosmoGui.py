...
class Ui_CosmoWindow(object):
    def setupUi(self, CosmoWindow):
        ...
        self.DAQConfig = QtWidgets.QWidget()
        self.DAQConfig.setObjectName("DAQConfig")
        self.pTE_DAQConfig = QtWidgets.QPlainTextEdit(self.DAQConfig)
        self.pTE_DAQConfig.setGeometry(QtCore.QRect(0, 10, 521, 411))
        self.pTE_DAQConfig.setReadOnly(True)
        self.pTE_DAQConfig.setObjectName("pTE_DAQConfig")
        self.tabWidget.addTab(self.DAQConfig, "")
        ...
        self.pB_SaveConfig.setGeometry(QtCore.QRect(220, 474, 101, 34))
        ...
        self.pB_ReloadConfig.setGeometry(QtCore.QRect(423, 466, 111, 30))
    ...
    def retranslateUi(self, CosmoWindow):
        ...
        self.DAQConfig.setToolTip(_translate("CosmoWindow", "List of configuration files"))
        self.pTE_DAQConfig.setToolTip(_translate("CosmoWindow", "DAQ configuration: list of configuration filenames"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.DAQConfig), _translate("CosmoWindow", "DAQConfig"))
        ...
        self.pB_SaveConfig.setText(_translate("CosmoWindow", "Save Config"))
        self.pB_ReloadConfig.setText(_translate("CosmoWindow", "Reload Config"))
