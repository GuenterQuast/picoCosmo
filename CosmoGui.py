...
class Ui_CosmoWindow(object):
    def setupUi(self, CosmoWindow):
        ...
        self.pB_ReloadConfig.setGeometry(QtCore.QRect(419, 593, 111, 31))
    ...
    def retranslateUi(self, CosmoWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.OsciConfig), _translate("CosmoWindow", "Oscilloscope config"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.BMconfig), _translate("CosmoWindow", "BufferManager config"))
